...
input_folder = "dwd-sunshine\\data\\1-final-data-state-neme"  # Folder containing original CSV files
output_folder = "dwd-sunshine\\data\\2-final-data-state-code"  # Folder for modified CSVs
...
csv_files = sorted([f for f in os.listdir(input_folder) if f.startswith("sunshine_") and f.endswith(".csv")])
...
for file in csv_files:
    ...
    new_filename = f"sunshine_{year}.csv"
...
print("\n✅ All sunshine files updated with state codes!")
